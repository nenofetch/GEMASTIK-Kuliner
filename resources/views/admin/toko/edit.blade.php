                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                                    name="nama" placeholder="Silakan masukan nama" autofocus autocomplete="off"
                                    value="{{ $toko->nama }}">
                                @error('nama')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea name="deskripsi" id="deskripsi" class="form-control" rows="1"
                                    placeholder="Silakan masukan deskripsi">{{ $toko->deskripsi }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea name="alamat" id="alamat"
                                    class="form-control  @error('alamat') is-invalid @enderror" rows="1"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="file" name="foto" id="foto"
                                    class="form-control @error('foto') is-invalid @enderror" value="{{$toko->foto}}"
                                    accept="image/*">
                                @error('foto')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="file" name="dokumen" id="dokumen"
                                    class="form-control @error('foto') is-invalid @enderror" value="{{$toko->dokumen}}">
                                @error('dokumen')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
